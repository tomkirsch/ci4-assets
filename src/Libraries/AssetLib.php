...
namespace Tomkirsch\Assets\Libraries;
...
class AssetLib
{
	...
	public function runMinify(bool $cleanOutputBuffer = TRUE)
	{
		...
		// is there an autoload.php in the config path from COMPOSER_PATH? remove it
		if (stristr($configPath, 'autoload.php') !== FALSE) {
			$configPath = str_replace('autoload.php', '', $configPath);
		}
